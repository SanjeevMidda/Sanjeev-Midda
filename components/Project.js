  ...
  return (
    <div className='project'>
        ...
        <div className="productDetails">
            ...
            {
                projectSelected === "chatGPT" && <ProjectItem projectName=" DALLE.E Image Generator" purpose=": Leverage DALLE.E to create a truly unique image. The user can enter exactly what they would like, or can get the system to generate a unique suggestion, and leave it to DALLE.E to summon a unique image. React and Tailwind css are used for the frontend. The user can save any image DALLE.E generates, for later viewing. This is implemented using node, express, and mongoDB for our backend. Cloudinary, in addition, is used for optimising media retrieval. " techStack = {["react", "mongoDB", "node & express", "cloudinary", "openAI", "tailwind css"]} sourceCode = "https://github.com/SanjeevMidda/chatGPT-image-generator" image={chatGPT}/>
            }
            {
