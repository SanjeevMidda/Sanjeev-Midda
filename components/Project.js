  ...
  return (
    <div className='project'>
        ...
        <div className="productDetails">
            ...
            {
                projectSelected === "chatGPT" && <ProjectItem projectName=" chatGPT Image Generator" purpose=": Leverage chatGPT to create a truly unique image. The user can enter exactly what they would like, or can get the system to generate a unique suggestion, and leave it to chatGPT to summon a unique image. React and Tailwind css are used for the frontend. The user can save any image chatGPT generates, for later viewing. This is implemented using node, express, and mongoDB for our backend. Cloudinary, in addition, is used for optimising media retrieval. " techStack = {["react", "mongoDB", "node & express", "cloudinary", "openAI", "tailwind css"]} sourceCode = "https://github.com/SanjeevMidda/chatGPT-image-generator" image={chatGPT}/>
            }
            {
